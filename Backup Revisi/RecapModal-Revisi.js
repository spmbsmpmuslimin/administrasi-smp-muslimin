...
const RecapModal = ({
  ...
  const getStatusBadge = (status) => {
    ...
    const statusMap = {
      ...
      alpha: { text: "A", color: "bg-red-500 text-white" },
    };
  ...
  }, [showModal, rekapMonth, selectedClass, selectedSubject, homeroomClass, students]); // Add dependencies to fix linter warnings
