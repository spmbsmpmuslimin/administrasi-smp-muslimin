...
const ExportModal = ({ type = "monthly", show, onClose, onExport, loading }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div
        className={`${
          darkMode ? "bg-gray-800 text-white" : "bg-theme-bg"
      ...
      >
        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-t-xl flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="bg-theme-bg bg-opacity-20 p-2 rounded-lg">
            ...
            <div className="mb-4">
              <label
                className={`block text-sm font-medium mb-2 ${
                  darkMode ? "text-gray-200" : "text-theme-secondary"
                }`}
              >
                Pilih Semester
              </label>
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 p-3 rounded-lg border transition ${
                    darkMode ? "border-gray-600" : "border-theme"
                  } ${
                    selectedSemester === "1"
              ...
              <p className={`text-xs mt-2 ${darkMode ? "text-gray-400" : "text-theme-secondary"}`}>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className={`w-full p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition ${
                  darkMode ? "bg-gray-700 border-gray-600 text-white" : "border border-theme"
                }`}
              >
            ...
            <button
              ...
              className={`flex-1 px-4 py-3 rounded-lg border font-medium transition disabled:opacity-50 ${
                darkMode
                  ...
                  : "bg-theme-surface border-theme text-theme-secondary hover:bg-gray-200"
              }`}
            >
              Batal
            </button>
