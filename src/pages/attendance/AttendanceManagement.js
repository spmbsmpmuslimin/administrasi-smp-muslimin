...
const AttendanceManagement = ({ user, onShowToast }) => {
  ...
  const EditModal = () => {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-theme-bg rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          {/* Header */}
  ...
  const ChangeDateModal = () => {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-theme-bg rounded-xl shadow-2xl w-full max-w-md">
          ...
          <div className="p-6">
            <div className="mb-4">
              ...
              <input
                ...
                disabled
                className="w-full p-3 bg-theme-bg text-theme border border-theme rounded-lg bg-theme-surface"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full p-3 bg-theme-bg text-theme border border-theme rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
              />
            </div>
