      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        ...
        <div className="relative flex-1">
          <select
            ...
            className="w-full appearance-none pl-3 pr-9 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 bg-white">
