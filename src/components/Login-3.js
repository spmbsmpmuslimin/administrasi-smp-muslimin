...
export const Login = ({ onLogin, onShowToast }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden flex-1 lg:flex-[3] bg-slate-900 slide-in-right">
