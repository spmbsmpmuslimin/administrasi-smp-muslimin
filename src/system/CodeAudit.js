...
import { RefreshCw, Terminal, Clock, FileCode2, ChevronDown, ChevronRight } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {category.issues.length === 0 ? (
            <span className="text-xs text-green-600 dark:text-green-400 font-medium">Aman ✅</span>
          ) : (
            <span
      ...
      {!loading && report && (
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            <SummaryCard label="Status" value={STATUS_ICON[report.summary.status]} colorClass="" />
            <SummaryCard
              label="Critical"
