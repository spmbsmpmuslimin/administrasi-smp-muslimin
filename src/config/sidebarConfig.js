...
export const sidebarGroups = [
...

  {
    ...
    items: [
      ...
      {
        page: "portal-ujian",
        label: "Portal Panitia Ujian",
        icon: [
          "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
        ],
        // Cuma nongol buat guru/guru_bk/petugas_perpus yang lagi kedaftar
        // jadi panitia ujian aktif (isPanitiaUjian dihitung sekali pas
        // login di Login.js, lihat portalUjianSupabase.js -> isPanitiaAktif).
        // Kalau masa tugas panitianya berakhir, harus login ulang biar
        // status & menu ini ke-refresh (isPanitiaUjian gak dicek ulang
        // secara live selama sesi berjalan).
        show: (ctx) => ctx.isPanitiaUjian || ctx.userRole === "developer",
      },
      {
        page: "konseling",
