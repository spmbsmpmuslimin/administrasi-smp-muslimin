    ...
    try {
      ...
      showToast(
        `✅ Tahun ajaran ${yearTransition.newYear} berhasil dimulai!\n\n` +
          ...
          `⬆️ ${Object.values(preview.promotions).flat().length} siswa naik kelas (password akun ikut disesuaikan)\n` +
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <ul className="text-yellow-800 dark:text-yellow-400 text-sm space-y-2 mb-4 list-disc list-inside">
                  ...
                  <li>Password akun siswa yang naik kelas ikut disesuaikan</li>
                  <li>
