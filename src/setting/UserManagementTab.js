        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 mb-6 border border-blue-100 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              {/* Riwayat Aktivitas Button */}
              <button
                onClick={() => setShowAuditLog(true)}
                disabled={loading}
                className="flex items-center justify-center gap-2 px-4 py-3 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-600 text-white rounded-lg font-semibold transition-colors flex-shrink-0 text-sm min-h-[44px]"
              >
                <History size={18} />
              ...
              <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-200 rounded-lg p-4 mb-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-red-900 dark:text-red-300">{deleteTarget.full_name}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-red-700">Username:</span>
                    <span className="font-semibold text-red-900 dark:text-red-300">@{deleteTarget.username}</span>
                  </div>
                  {deleteTarget.teacher_id && (
                    <div className="flex justify-between">
                      <span className="text-red-700">ID Guru:</span>
                      <span className="font-semibold text-red-900 dark:text-red-300 font-mono">
                        {deleteTarget.teacher_id}
                      </span>
                    </div>
                  )}
