          ...
          <div className="lg:col-span-1 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-5 md:p-6 border border-blue-100 dark:border-gray-700">
              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  className="inline-flex items-center h-9 bg-gray-200 dark:bg-gray-600 rounded-full p-1 transition-colors duration-300"
                  role="group"
                >
                  <button
                    onClick={() => !darkMode && onToggleDarkMode?.()}
                    className={`flex items-center gap-1.5 px-3 h-9 rounded-full transition-all duration-300 ${
                      !darkMode
                  ...
                  <button
                    ...
                    aria-pressed={darkMode}
                  >
                    <Moon size={14} fill={darkMode ? "currentColor" : "none"} />
