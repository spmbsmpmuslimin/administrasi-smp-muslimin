...
export default function RaportConfig({ user, showToast, darkMode }) {
  ...
  const bgColor = darkMode ? "bg-gray-800" : "bg-theme-bg";
  const textColor = darkMode ? "text-white" : "text-theme";
  const textSecondary = darkMode ? "text-gray-400" : "text-theme-secondary";
  const borderColor = darkMode ? "border-theme" : "border-theme";
