    ...
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-4 lg:px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-3 sm:p-4 border-l-4 border-purple-500">
          <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Sudah Transfer</div>
          <div className="text-2xl sm:text-3xl font-bold text-purple-600 dark:text-purple-400">
            {allStudents.filter((s) => s.is_transferred).length}
          </div>
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">siswa aktif di sistem</div>
        </div>
      </div>
          ...
          {isEditModeActive && (
            <div className="mt-2 sm:mt-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-2 sm:p-3">
              <p className="text-xs sm:text-sm text-orange-800 dark:text-orange-300">
                <strong>Mode Edit Aktif:</strong> Drag & drop siswa antar kelas, klik "Edit" untuk
                tambah/hapus siswa, atau gunakan "Swap" untuk tukar siswa.
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden mx-2 sm:mx-4">
            <div className="bg-orange-600 dark:bg-orange-700 text-white p-3 sm:p-4 flex justify-between items-center">
              <h3 className="text-lg sm:text-xl font-bold">✏️ Edit Kelas {editingClass}</h3>
              <button
                onClick={() => {
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                    ...
                    <div className="divide-y dark:divide-gray-700">
                      {classDistribution[editingClass].map((student) => (
                        <div
                          ...
                          draggable={editMode}
                          onDragStart={(e) =>
                            handleDragStart(e, student, editingClass, setDraggedStudent)
                          }
                        >
              ...
              {/* Available Students */}
              <div>
                <h4 className="font-semibold mb-2 sm:mb-3 dark:text-gray-100">➕ Tambah Siswa</h4>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="mb-4 p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                  <strong>Info:</strong> Perubahan akan langsung tersimpan ke database. Drag & drop
                  siswa ke kelas lain untuk memindahkan.
                </p>
              </div>
                    ...
                    {savedClassDistribution[activeClassView]
                      ...
                      .map((student, idx) => (
                        <tr
                          ...
                          draggable={true}
                          onDragStart={(e) =>
                            handleDragStart(e, student, activeClassView, setDraggedStudent)
                          }
                        >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden mx-2 sm:mx-4">
            <div className="bg-blue-600 dark:bg-blue-700 text-white p-3 sm:p-4 flex justify-between items-center">
              <h3 className="text-lg sm:text-xl font-bold">Detail Kelas {activeClassView}</h3>
              <button
                onClick={() => setActiveClassView(null)}
                  ...
                  return (
                    <>
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded p-2 sm:p-3">
                        ...
                        <div className="text-xs text-gray-600 dark:text-gray-400">Total Siswa</div>
                      </div>
                      <div className="bg-green-50 dark:bg-green-900/20 rounded p-2 sm:p-3">
                        <div className="text-xl sm:text-2xl font-bold text-green-600 dark:text-green-400">
                          {stats.males}:{stats.females}
                        </div>
                        <div className="text-xs text-gray-600 dark:text-gray-400">L : P</div>
                      </div>
                      <div className="bg-purple-50 dark:bg-purple-900/20 rounded p-2 sm:p-3">
                        <div className="text-xl sm:text-2xl font-bold text-purple-600 dark:text-purple-400">
                          {stats.schoolCount}
                        </div>
                        <div className="text-xs text-gray-600 dark:text-gray-400">Asal SD</div>
                      </div>
                    </>
                  );
                })()}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden mx-2 sm:mx-4">
            <div className="bg-indigo-600 dark:bg-indigo-700 text-white p-3 sm:p-4 flex justify-between items-center">
              <h3 className="text-lg sm:text-xl font-bold">🔄 Tukar Posisi 2 Siswa</h3>
              <button
                onClick={() => {
            ...
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {getAllStudentsInDistribution(currentDistribution, showSavedClasses).map(
                      (item) => (
                        <option
                          key={item.uniqueId}
                          value={item.uniqueId}
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <button
                  ...
                  disabled={
                    !swapStudent1 || !swapStudent2 || !swapStudent1.student || !swapStudent2.student
                  }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-red-700 rounded-lg shadow-2xl max-w-md w-full p-4 sm:p-6 text-white border-4 border-red-900 mx-2 sm:mx-4">
            ...
            <p className="text-center font-semibold mb-4 text-sm sm:text-base">
              APAKAH ANDA <span className="text-yellow-300 font-black">YAKIN</span> INGIN
              MELANJUTKAN INI ?
            </p>
